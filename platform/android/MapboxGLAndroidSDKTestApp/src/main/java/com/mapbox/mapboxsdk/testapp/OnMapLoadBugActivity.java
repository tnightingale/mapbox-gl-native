...
import com.mapbox.mapboxsdk.testapp.offline.SmallLargeDownloadRegionDialog;
...
public class OnMapLoadBugActivity extends AppCompatActivity
        implements SmallLargeDownloadRegionDialog.DownloadRegionDialogListener {

    private final static String LOG_TAG = "OnMapLoadBugActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                ...
                Toast.makeText(OnMapLoadBugActivity.this, "onMapReady called!", Toast.LENGTH_SHORT).show();

                LatLng center = new LatLng(-41.307, 174.764);
                ...
                MarkerOptions options = new MarkerOptions().position(new LatLng(-41.307, 174.764));
    ...
    private void handleDownloadRegion() {
        ...
        // Show dialog
        SmallLargeDownloadRegionDialog downloadRegionDialog = new SmallLargeDownloadRegionDialog();
        ...
        mOfflineManager.listOfflineRegions(new OfflineManager.ListOfflineRegionsCallback() {
            ...
            public void onList(OfflineRegion[] offlineRegions) {
                ...
                if (offlineRegions == null || offlineRegions.length == 0) {
                    Toast.makeText(OnMapLoadBugActivity.this, "You have no regions yet.", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    @Override
    public void onDownloadRegionDialogPositiveClick(final String regionName, final OfflineRegionDefinition definition) {
        // Start progress bar
    ...
    private void endProgress(final String message) {
        ...
        // Show a toast
        Toast.makeText(OnMapLoadBugActivity.this, message, Toast.LENGTH_LONG).show();
    }
